...
I am interesting in conducting an experiment that helps me conduct rigorous statistical analysis to study how caffeine affects pulse rate. In order to conduct the experiment, I chose three of my friends as candidates (participants) of this experiment, and had them consume 50 mg, 100 mg, and 200 mg caffeine pills, each at separate days, and then recorded the change in average pulse rate before and after the consumption of caffeine pill. It is well-studied in papers like [Gonzaga LA et al.](https://www.nature.com/articles/s41598-017-14540-4) and [Karapetian GK et al.](https://pubmed.ncbi.nlm.nih.gov/22499570/) that caffeine is attributed to a subsequent decrease in pulse rate. This research however studies the effect of caffeine on decrease in pulse rate specifically based on quantity of caffeine consumed (50 mg, 100 mg, and 200 mg).
...
1. Allows us to block two nuisance variables that we wish to keep separate (`Day` and `Participant`).
...
3. Only 9 number of runs required, therefore making our experiment both time and cost effective.

## Shortcomings of Design

1. The number of levels of each blocking variable must be the same as the levels of treatment factor. As two of my participants are male, and one is female, the design does not allow us to block confounding effect of gender.

2. The experiment could not be conducted in a controlled setting, due to which there may have been many underlying confounding effects which could not be controlled. An example of a confounding effect that could not be controlled is the time of day when the caffeine pill is consumed. 
...
* I then administered the designated dosage of caffeine pill, I waited for approximately 45 minutes, then re-took measurements for 5 minutes and recorded the data.
...
```{r, echo = F}
Day_1_Participant_A_night_initial <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_1_Participant_A_night_initial.csv')
...
Day_1_Participant_A_night_final <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_1_Participant_A_night_final.csv')
...
```{r, echo = F}
Day_1_Participant_B_afternoon_initial <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_1_Participant_B_afternoon_initial.csv')
...
Day_1_Participant_B_afternoon_final <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_1_Participant_B_afternoon_final.csv')
...
```{r, echo = F}
Day_1_Participant_C_morning_initial <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_1_Participant_C_morning_initial.csv')
...
Day_1_Participant_C_morning_final <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_1_Participant_C_morning_final.csv')
...
```{r, echo = F}
Day_2_Participant_A_afternoon_initial <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_2_Participant_A_afternoon_initial.csv')
...
Day_2_Participant_A_afternoon_final <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_2_Participant_A_afternoon_final.csv')
...
```{r, echo = F}
Day_2_Participant_B_morning_initial <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_2_Participant_B_morning_initial.csv')
...
Day_2_Participant_B_morning_final <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_2_Participant_B_morning_final.csv')
...
```{r, echo = F}
Day_2_Participant_C_night_initial <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_2_Participant_C_night_initial.csv')
...
Day_2_Participant_C_night_final <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_2_Participant_C_night_final.csv')
...
```{r, echo = F}
Day_3_Participant_A_morning_initial <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_3_Participant_A_morning_initial.csv')
...
Day_3_Participant_A_morning_final <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_3_Participant_A_morning_final.csv')
...
```{r, echo = F}
Day_3_Participant_B_night_initial <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_3_Participant_B_night_initial.csv')
...
Day_3_Participant_B_night_final <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_3_Participant_B_night_final.csv')
...
```{r, echo = F}
Day_3_Participant_C_afternoon_initial <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_3_Participant_C_afternoon_initial.csv')
...
Day_3_Participant_C_afternoon_final <- read.csv('/Users/shrivats_sudhir/Documents/University of Wisconsin Madison /Semester 4/Statistical Experimental Design/Project/Day_3_Participant_C_afternoon_final.csv')
...
We can see that the paired-groups B-A [100 mg caffeine vs 50 mg caffeine] and groups C-A [200 mg caffeine vs 50 mg caffeine] are statistically significant. However, the paired-group C-B [200 mg vs 100 caffeine] is not statistically significant. This could imply that the effects of caffeine on pulse rate is most significant when taking over 50 mg, but not so different when taking over 100 mg or 200 mg.
